...
**Project Subject:** Deep Reinforcement Learning for Strategic Budget Allocation
...
**Project Subject:** Reinforcement Learning for Dynamic Pricing
...
**Project Subject:** Causal Inference for Marketing Campaign Optimization
...
**Project Subject:** Credit Card Default Prediction with XAI and Fairness Audit
...
**Project Subject:** Multi-Label Product Classification: Classic vs. LLM Approach
* Compared a classic supervised model (98% Acc) against a zero-shot Large Language Model for product classification.
* ![Python](https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=white) ![Hugging Face](https://img.shields.io/badge/🤗_Hugging_Face-FFD21E) ![PyTorch](https://img.shields.io/badge/PyTorch-EE4C2C?logo=pytorch&logoColor=white) ![NLP](https://img.shields.io/badge/NLP-blue)

**Project Subject:** Deploying a Real-Time Fraud Detection Microservice
...
**Project Subject:** Supply Chain Forecasting with Graph Neural Networks
...
**Project Subject:** Predictive Maintenance for NASA Turbofan Engines
...
**Project Subject:** Discovering Product Ecosystems with Network Analysis
...
**Project Subject:** Real-Time IoT Intrusion Detection
...
**Project Subject:** Fraud Detection with a TensorFlow LSTM Autoencoder
...
**Project Subject:** Predicting Customer's Next Action in an Online Clickstream
...
**Project Subject:** CRM Digital Twin & Interactive Business Intelligence Dashboard
...
**Project Subject:** Geospatial Hotspot Analysis for Retail Strategy
...
**Project Subject:** AI-Powered Customer Segmentation
...
**Project Subject:** E-commerce Conversion Prediction
...
**Project Subject:** Large-Scale Social Media Sentiment Analysis
...
**Project Subject:** Predict Students' Dropout and Academic Success
...
**Project Subject:** Human Activity Recognition (HAR) with Smartphone Data
...
**Project Subject:** Time-Series Forecasting for Bike Share Demand
...
**Project Subject:** Time-Series Forecasting of Household Power Consumption
* Predicted daily household electricity consumption with a high R-squared of 0.957.
* ![Python](https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=white) ![XGBoost](https://img.shields.io/badge/XGBoost-006699)

**Project Subject:** Socio-Economic Factors for Income Prediction
* Predicted income level from census data with 87% accuracy.
* ![Python](https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=white) ![XGBoost](https://img.shields.io/badge/XGBoost-006699)

**Project Subject:** Wine Quality Prediction
...
**Project Subject:** Air Quality Prediction
