...
The projects are tiered, from the most technically advanced and research-aligned work to foundational applications.

### Tier 1: Advanced AI for Prescriptive & Strategic Analytics

1. **[Deep Reinforcement Learning for Strategic Budget Allocation](Deep_Reinforcement_Learning_for_Budget_Allocation.ipynb)**
...
3. **[Causal Inference for Marketing Campaign Optimization](Causal_Inference_Kevin_Hillstrom_Email_Analytics.ipynb)**
    * Used a Causal Forest to measure campaign uplift and generate personalized recommendations for 64k customers.
    * ![Python](https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=white) ![Scikit-learn](https://img.shields.io/badge/Scikit--learn-F7931A?logo=scikit-learn&logoColor=white) ![Causal Inference](https://img.shields.io/badge/Causal_Inference-darkgreen) ![EconML](https://img.shields.io/badge/EconML-8A2BE2)

### Tier 2: Responsible AI, MLOps & Advanced Model Interpretation

4. **[Credit Card Default Prediction with XAI and Fairness Audit](Credit_Card_Default_Prediction_with_XAI_and_Fairness_Audit(1).ipynb)**
...
5. **[Multi-Label Product Classification and Topic Modeling](Multi_Label_Product_Classification_and_Topic_Modeling.ipynb)**
...
6. **[Deploying a Real-Time Fraud Detection Microservice](Fraud_Detection_Microservice_Auth_Fixed.ipynb)**
    * Operationalized a deep learning fraud model as a scalable, real-time microservice using an MLOps stack.
...
7. **[Supply Chain Forecasting with Graph Neural Networks](Supply_Chain_Forecasting_with_Graph_Neural_Networks.ipynb)**
...
8. **[Predictive Maintenance for NASA Turbofan Engines](Predictive_Maintenance_for_NASA_Turbofan_Engines_using_Bi_LSTM.ipynb)**
...
9. **[Discovering Product Ecosystems with Network Analysis](Product_Ecosystems_with_Network_Analysis.ipynb)**
...
10. **[Real-Time IoT Intrusion Detection](Real_Time_IoT_Intrusion_Detection.ipynb)**
...
11. **[Fraud Detection with a TensorFlow LSTM Autoencoder](Fraud_Detection_with_a_TensorFlow_LSTM_Autoencoder.ipynb)**
...
12. **[Predicting Customer's Next Action in an Online Clickstream](Predicting_Customer's_Next_Action_in_an_Online_Shopping_Clickstream.ipynb)**
...
13. **[CRM Digital Twin & Interactive Business Intelligence Dashboard](CRM_Digital_Twin_and_Interactive_Business_Intelligence_Dashboard.ipynb)**
...
14. **[Geospatial Hotspot Analysis for Retail Strategy](Geospatial_Hotspot_Analysis_for_Retail_Strategy.ipynb)**
...
15. **[AI-Powered Customer Segmentation](AI_Powered_Customer_Segmentation_with_K_Means_and_PCA.ipynb)**
...
16. **[E-commerce Conversion Prediction](E_commerce_Conversion_Prediction_with_Machine_Learning.ipynb)**
...
17. **[Large-Scale Social Media Sentiment Analysis](Large_Scale_Social_Media_Sentiment_Analysis.ipynb)**
...
18. **[Predict Students' Dropout and Academic Success](Predict_Students'_Dropout_and_Academic_Success.ipynb)**
...
19. **[Human Activity Recognition (HAR) with Smartphone Data](Human_Activity_Recognition_(HAR)_with_Smartphone_Data.ipynb)**
...
20. **[Time-Series Forecasting for Bike Share Demand](Time_Series_Forecasting_for_Bike_Share_Demand.ipynb)**
...
21. **[Time-Series Forecasting of Household Power Consumption](Time_Series_Forecasting_of_Household_Power_Consumption.ipynb)**
    * Predicted daily household electricity consumption with a high R-squared of 0.957.
    * ![Python](https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=white) ![XGBoost](https://img.shields.io/badge/XGBoost-006699)

22. **[Socio-Economic Factors for Income Prediction](Socio_Economic_Factors_for_Income_Prediction.ipynb)**
    * Predicted income level from census data with 87% accuracy.
    * ![Python](https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=white) ![XGBoost](https://img.shields.io/badge/XGBoost-006699)

23. **[Wine Quality Prediction](Wine_Quality.ipynb)**
...
24. **[Air Quality Prediction](Air_Quality.ipynb)**
